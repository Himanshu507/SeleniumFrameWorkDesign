...
public class BaseTest extends DataReader {
	...
	public ConfirmationPage conf_page;
	public PaymentPage paymentpage;
	public ProductCatalogue productcatalogue;
	GetWebDriver driv_inst = new GetWebDriver();
	...
	public void launchApplication() throws IOException {
		...
		conf_page = new ConfirmationPage(driver);
	...
	public List<HashMap<String, String>> getJsonDataToMap(String path) throws IOException {
		String jsonString = FileUtils.readFileToString(new File(System.getProperty("user.dir") + path),
